...
if __name__ == '__main__':
    ...
    #         'readable_name': 'HTRU2',
    #         'best_nn_params': {'NN__activation': ['relu'], 'NN__alpha': [1.0],
    #                            'NN__hidden_layer_sizes': [(16,)], 'NN__learning_rate_init': [0.016]}
    # }
    dataset1_details = {
        'data': loader.AdultSalary(verbose=verbose, seed=seed),
        'name': 'adult_salary',
        'readable_name': 'Adult Salary >= 50k',
        'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [0.00316228],
                           'NN__hidden_layer_sizes': [(16,)], 'NN__learning_rate_init': [0.064]}
    }
    dataset2_details = {
        'data': loader.BankMarketingData(verbose=verbose, seed=seed),
        'name': 'bank_marketing',
        'readable_name': 'Bank Marketing',
        'best_nn_params': {'NN__activation': ['logistic'], 'NN__alpha': [1.00E-06],
                           'NN__hidden_layer_sizes': [(36, 36)], 'NN__learning_rate_init': [0.064]}
    }
    if args.dataset1:
